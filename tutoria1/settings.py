"""
Django settings for tutoria1 project.
...
INSTALLED_APPS = [
    ...
    'quiz.apps.QuizConfig', # added the new new app
    'crispy_forms', # for good loing forms
]
...
WSGI_APPLICATION = 'tutoria1.wsgi.application'
